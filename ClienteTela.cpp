...
#include "ui_ClienteTela.h"

ClienteTela::ClienteTela(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::ClienteTela)
{
    ui->setupUi(this);
}
...
void ClienteTela::on_pushButtonIncluir_clicked()
{
    TelaCliente tl;
    tl.setModal(true);
    tl.exec();
...
void ClienteTela::on_pushButtonAlterarTelaListagem_clicked()
{
    telaAlterarCliente tl;
    tl.setModal(true);
    tl.exec();
    this->on_pushButton_ListarCliente_clicked();
}

void ClienteTela::on_pushButton_ListarCliente_clicked()
{
    try {
...
void ClienteTela::on_pushButton_clicked()
{
    this->close();
}
